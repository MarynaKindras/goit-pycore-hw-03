...
users = [
    ...
    {"name": "Jane Smith", "birthday": "1993.06.25"},
    {"name": "Tom Adams", "birthday": "1995.04.25"},
    {"name": "Mayam Seid", "birthday": "1980.12.09"},
]

upcoming_birthdays = get_upcoming_birthdays(users)
print("Список днів народжень цього тижня:", upcoming_birthdays)
